		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-md-6 col-lg-7">
					<img src="<%=request.getContextPath()%>/resources/vendors/images/login-page-img.png" alt="">
				</div>
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h2 class="text-center text-primary">Login To HTM</h2>
						</div>
						<form id="login" action="/HTM/login/submit" method="POST">
							<div class="select-role">
								<div class="btn-group btn-group-toggle" data-toggle="buttons">
									<label class="btn active">
										<input type="radio" name="options" id="admin">
										<div class="icon"><img src="<%=request.getContextPath()%>/resources/vendors/images/briefcase.svg" class="svg" alt=""></div>
										<span>I'm</span>
										Manager
									</label>
									<label class="btn">
										<input type="radio" name="options" id="user">
										<div class="icon"><img src="<%=request.getContextPath()%>/resources/vendors/images/person.svg" class="svg" alt=""></div>
										<span>I'm</span>
										Member
									</label>
								</div>
							...
							<div class="row">
								<div class="col-sm-12">
									<div class="input-group mb-0">
										...
										-->
										<input type="submit" class="btn btn-primary btn-lg btn-block">Sign In</input>
									</div>
								</div>
							</div>
						</form>
